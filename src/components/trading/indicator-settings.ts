...
> = {
  SMA: [{ key: 'period', label: 'Period', min: 1, max: 500, step: 1, type: 'integer' }],

  EMA: [{ key: 'period', label: 'Period', min: 1, max: 500, step: 1, type: 'integer' }],

  WMA: [{ key: 'period', label: 'Period', min: 1, max: 500, step: 1, type: 'integer' }],

  BOLLINGER_BANDS: [
    { key: 'period', label: 'Period', min: 1, max: 500, step: 1, type: 'integer' },
    { key: 'deviation', label: 'Deviation', min: 1, max: 10, step: 0.1, type: 'decimal' },
  ],
  ...
  AWESOME_OSCILLATOR: [
    { key: 'fastPeriod', label: 'Fast SMA', min: 1, max: 500, step: 1, type: 'integer' },
    { key: 'slowPeriod', label: 'Slow SMA', min: 1, max: 500, step: 1, type: 'integer' },
  ],

  RSI: [{ key: 'period', label: 'Period', min: 1, max: 500, step: 1, type: 'integer' }],

  MACD: [
    { key: 'fastPeriod', label: 'Fast EMA', min: 1, max: 500, step: 1, type: 'integer' },
    { key: 'slowPeriod', label: 'Slow EMA', min: 1, max: 500, step: 1, type: 'integer' },
    { key: 'signalPeriod', label: 'Signal SMA', min: 1, max: 500, step: 1, type: 'integer' },
  ],

  CCI: [{ key: 'period', label: 'Period', min: 1, max: 500, step: 1, type: 'integer' }],

  ADX: [{ key: 'period', label: 'Period', min: 1, max: 500, step: 1, type: 'integer' }],

  ATR: [{ key: 'period', label: 'Period', min: 1, max: 500, step: 1, type: 'integer' }],
